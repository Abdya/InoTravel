    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                        <form method="post" class="container blur-form col-md-6" style="width: 1400px;  max-width: 1400px">
                            <div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" v-bind:value="user.firstName" name="firstName" id="firstName" placeholder="Имя">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lastName" class="col-sm-5 col-form-label">Фамилия</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="lastName" name="lastName" value="afawffggbbb" placeholder="Фамилия">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email" class="col-sm-5 col-form-label">Email</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="email" name="email" value="awddawgfawf" placeholder="Email">
                                </div>
                            </div>
                        ...
                        <form method="post" action="" class="container blur-form col-md-6" style="width: 1400px;  max-width: 1400px">
                            <div>
